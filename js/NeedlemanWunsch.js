 ...
 */
 ...
 /*
* Some modifications are done by Kamila Kolpashnikova 2020 
* to fit the needs for the optimal matching in social sciences
* modifications are distributed without any warranty 
 */
...
var GridBuilder = (function () {
    ...
    function showTooltip(x, y) {
        ...
        $tr.append(
            ...
            $("<td />").html("<b><u>The minimum of three</u></b> <br> " + targetCell.winningScore)
        );
        $table.append($tr);
    ...
    mSelf = {
        ...
        rebuildTable: function(domContainer, resultContainer, matchScore, mismatchScore, gapScore, seqSide, seqTop) {
            ...
            mMismatchScore = -1*mismatchScore;
            mGapScore = -1*gapScore;
            ...
            for (var i = 0; i < width; i++) {
                ...
                for (var j = 0; j < height; j++) {
                    ...
                    */
                    ...
                    mPathTable[i][j] = Math.min(moveUpScore, moveSdScore, moveDgScore);
                    ...
                    */
                    ...
                    mCellMap[i + "_" + j] = {
                        'sideScoreText': mPathTable[i - 1][j] + " + " + gapScore + " (Indel) = " + moveSdScore,
                        'upScoreText': mPathTable[i][j - 1] + " + " + gapScore + " (Indel) = " + moveUpScore,
                        'diagonalScoreText': mPathTable[i - 1][j - 1]  + " + " +  
                            parseInt(comparisonScore, 10) +
                            " (" + (isMatch ? "No subst." : "Substitution") +
